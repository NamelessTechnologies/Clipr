...
const FollowingModal: React.FC<propTypes> = (props: { open: boolean, onClose: ()=>void, profile_id: string }) => {
    ...
    <div 
      ...
      onClick={onClose}>
        <div
          ...
          {/* {children} */}
          <div className="following-container pt-3">
        ...
        {user?.map((user) => (
            <div 
              ...
              <div className="flex flex-col">
                <div className="text-white italic text-m pr-2">
                {user.nickname}
                </div>
