...
function CommentBox() {
    ...
    return (
        <div className="flex flex-col w-96 bg-neutral-900 rounded-xl">
            ...
            <div className="flex flex-col items-center w-full h-full">
                <Comment commentData={mockComment1} />
                <Comment commentData={mockComment2} />
                <Comment commentData={mockComment3} />

            </div>

            <div className="flex items-center pl-4 pr-6 py-10 w-full h-16 rounded-b-xl">
                <img
