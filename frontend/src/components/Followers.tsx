...
interface FollowerProps {
  onSendFollowerCount: (data: number) => void;
}

function Followers ({ onSendFollowerCount }: FollowerProps)  {
  ...
  useEffect(() => {
    if (followerCount) {
      onSendFollowerCount(user.length);
    }
  }, [followerCount, onSendFollowerCount])
